...
function toUpdate(){
  if (window.localStorage.getItem("updatePaxSplitVerticalB") == "true"){
    return callFunction();
  }
}
      ...
      .get(function(error,data){
          ...
          for (year = 0; year < yrList.length; year++){
            ...
            rects.on("mouseover",function(d){
                ...
                console.log(window.localStorage.getItem("paxagtidSplitV"));
            });
          ...
          */
          chartGroup.append("text")
                      ...
                      .text(localStorage.getItem("paxSplitVertConB"));
          // chartGroup.append("text")
          //             .attr("x", "0px")
          //             .attr("y", margin.top*5)
          //             .attr("class","description")
          ...
          */
          ...
          // }
           ...
           function pickAgtCon(d){
             var con = String(localStorage.getItem("paxSplitVertConB"));
