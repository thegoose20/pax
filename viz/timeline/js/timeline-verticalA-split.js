...
function toUpdate(){
  if (window.localStorage.getItem("updatePaxSplitVerticalA") == "true"){
    return callFunction();
  }
}
...
function callFunction() {
  ...
  d3.csv("data/paxTimelineData_02092018.csv")
      ...
      .get(function(error,data){
          ...
          window.localStorage.setItem("paxMinYearSplitV", minYear); // same for all vertical timelines
          window.localStorage.setItem("paxMaxYearSplitV", maxYear); // same for all vertical timelines
          ...
          for (year = 0; year < yrList.length; year++){
            ...
            rects.on("click", function(d) {
              if (+d.AgtId != +selectionSplitV){
                ...
                window.localStorage.setItem("updatePaxSplitVerticalC", "true"); // Deselect any selected agreement on right vertical timeline
                // console.log(window.localStorage.getItem("paxselectionSplitV"));
                callFunction();
              } else { // if clicked
                // console.log(this.id);
          ...
          */
          chartGroup.append("text")
                      ...
                      .text(localStorage.getItem("paxSplitVertConA"));
          // chartGroup.append("text")
          //             .attr("x", "0px")
          //             .attr("y", margin.top*5)
          //             .attr("class","description")
          ...
          */
          ...
          function pickAgtCon(d){
            var con = String(localStorage.getItem("paxSplitVertConA"));
